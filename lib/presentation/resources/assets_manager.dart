...
class ImageManager {
  ...
  static const String signInAsset = "$imagePath/signin_asset.png";
  static const String signInAsset2 = "$imagePath/signin_asset_2.png";
  static const String otpAsset = "$imagePath/otp_asset.png";
  static const String otpAsset2 = "$imagePath/otp_asset_2.png";
  static const String resetPasswordAsset =
      "$imagePath/reset_password_asset.png";
  static const String resetPasswordAsset2 =
      "$imagePath/reset_password_asset_2.png";
  ...
  static const String categoryCoverTest = "$imagePath/test_category_cover.png";
...
class IconsManager {
  ...
  static const String iconLogIn = "$iconPath/logIn.json";
  static const String iconSoon = "$iconPath/soon.json";
  ...
  static const String iconFire = "$iconPath/fire_icon.svg";
  static const String iconKids = "$iconPath/kids_icon.svg";
  static const String iconLinks = "$iconPath/links_icon.svg";
  static const String iconMusic = "$iconPath/music_icon.svg";
