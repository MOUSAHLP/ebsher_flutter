              ...
              FilterButton(
                ...
                onTab: () {
                  if (vendorsListBloc.pendingFilter.visits != true) {
                    vendorsListBloc.add(
                        SetPendingSortingValue(GetVendorsParams(visits: true)));
                  } else {
                    vendorsListBloc.add(
                        SetPendingSortingValue(GetVendorsParams(visits: null)));
                  }
                },
              ),
              FilterButton(
              ...
              FilterButton(
                ...
                onTab: () {
                  if (vendorsListBloc.pendingFilter.recent != false) {
                    ...
                    vendorsListBloc.add(
                        SetPendingSortingValue(GetVendorsParams(recent: null)));
                  }
                },
              ),
              FilterButton(
                ...
                onTab: () {
                  if (vendorsListBloc.pendingFilter.recent != true) {
                    vendorsListBloc.add(
                        SetPendingSortingValue(GetVendorsParams(recent: true)));
                  } else {
                    vendorsListBloc.add(
                        SetPendingSortingValue(GetVendorsParams(recent: null)));
                  }
